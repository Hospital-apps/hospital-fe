...
//                           Duration(days: 30)), // Adjust the range if needed
//                       selectableDayPredicate: (DateTime date) {
//                         // Filter only days that match the doctor's schedule
//                         return controller.selectedDoctor.value?.schedules
//                                 .any((schedule) {
//                               return schedule.day == date.weekday.toString();
//                             }) ??
//                             false;
//                       },
//                     );
